...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Dompet : Шаблоны договоров</title>
            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Договоры</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Список шаблонов договора</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="public/doc/1.docx">Скачать</a>
														</div>
													</div>
												</td>
                                            </tr>
											<tr>
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
                                                            <a class="dropdown-item" href="public/doc/2.pdf" download>Скачать</a>
														</div>
													</div>
												</td>
                                            </tr>
											<tr>
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
                                                            <a class="dropdown-item" href="public/doc/3.docx" download>Скачать</a>
														</div>
													</div>
												</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>Купли-продажи недвижемости</td>
                                                <td>15 Декабрь 2017</td>
                                                ...
                                                <td>
													<div class="dropdown">
														...
														<div class="dropdown-menu">
                                                            <a class="dropdown-item" href="public/doc/4.docx" download>Скачать</a>
														</div>
													</div>
												</td>
                                            </tr>
