                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
								<a href="?report=true" class="btn btn-primary d-sm-inline-block d-none">Скачать отчет<i class="las la-signal ms-3 scale5"></i></a>
							</li>
                        </ul>
                    </div>
				</nav>
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							...
							<div class="header-info ms-3">
								<span class="font-w200 "><?=DBC::select('users','id',$_SESSION['admin']['id'],0,'name')?></span>
								<small class="text-end font-w400"><?=DBC::select('users','id',$_SESSION['admin']['id'],0,'email')?></small>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a href="?exit=true" class="dropdown-item ai-icon">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Основные</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="/">Доска</a></li>
							<li><a href="/depo">Депозиты</a></li>
				...
				<div class="copyright">
					<p><strong>Dompet</strong> © 2024 Все права защищены</p>
					<p class="fs-12">Разработано Маздубай Али</p>
				</div>
			</div>
        </div>
        <!--**********************************
